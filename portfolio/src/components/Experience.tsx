    ...
    <section id="experience" className="py-20 px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {timeline.map((item) => (
          <button
            ...
            className="text-left p-6 bg-surface rounded-lg shadow hover:bg-surface/80 transition"
          >
      ...
      {activeExp && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-background text-accent p-8 rounded-2xl max-w-2xl mx-auto overflow-auto max-h-[90vh]">
            ...
            <ul className="flex flex-wrap gap-2 mb-6">
              {activeExp.skillsUsed.map((s) => (
                <li key={s} className="text-m bg-surface/50 px-2 py-1 rounded">{s}</li>
              ))}
            </ul>
            <button
